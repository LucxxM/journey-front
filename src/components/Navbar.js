       ...
       <div className="link dropup_link">
         <ul>
           <li className="liRelative">
            <a title="img"><img className="clickable" src="./icons/logo12.png" alt="" /></a>
            <ul className="dropup_menu first display-none" id="ulToDisplay">
                <li className="liRelative">
                  <a title="img"><img className="clickable" src="./icons/avionDcol.png" alt="" /></a>
                ...
                <li className="liRelative">
                  <a title="img"><img className="clickable" src="./icons/avionATri.png" alt="" /></a>
                ...
                <li className="liRelative">
                  <a title="img"><img className="clickable" src="./icones/Sans titre.png" alt="" /></a>
           ...
           <li className="liRelative">
            <a title="img"><img className="clickable" src="./icons/calendar.png" alt="" /></a>
           ...
           <li className="liRelative">
            <a title="img"><img className="clickable" src="./icons/hebergement.png" alt="" /></a>
           ...
           <li className="liRelative">
            <a title="img"><img className="clickable" src="./icons/people.png" alt="" /></a>
